...
public class TrainerTahap_2Activity extends Activity {

    RecyclerView recyclerViewStudent;
    RecyclerView recyclerViewTeacher;
    public static EditText teacher_et_level2;
    public static EditText student_et_level2;
    public static int teacher_pressed_word_count_level2;
    public static int student_pressed_word_count_level2;
    public static int pressed_item_level2[];
    MyListAdapterTeacher adapterTeacher_level2;
    static MyListAdapterStudent adapterStudent_level2;
    ...
    public void onCreate(Bundle _savedInstanceState) {
        ...
        pressed_item_level2 = new int[]{-1, -1, -1};
        ...
        teacher_et_level2 = findViewById(R.id.teacher_et);
        ...
        teacher_clear_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                teacher_et_level2.setText("");
                student_et_level2.setText("");
                teacher_pressed_word_count_level2 = 0;
                student_pressed_word_count_level2 = 0;
                adapterStudent_level2.notifyItemChanged(pressed_item_level2[0]);
                adapterStudent_level2.notifyItemChanged(pressed_item_level2[1]);
                adapterStudent_level2.notifyItemChanged(pressed_item_level2[2]);
                pressed_item_level2[0] = -1;
                pressed_item_level2[1] = -1;
                pressed_item_level2[2] = -1;
        ...
        teacher_speak_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tts.speak(teacher_et_level2.getText().toString(), TextToSpeech.QUEUE_ADD, null);
            }
        });

        student_et_level2 = findViewById(R.id.student_et);
