...
public class SharePreferenceUtils {
    ...
    public static String LOGIN_STUDENT_ID;
    public static String LOGIN_STUDENT_NAME;
    public static TextToSpeech TTS;
    public static String LANG = "english";
    public static String LEVEL = "1";
    public static String IMG_FILE_PATH_TEACHER;
    public static String IMG_FILE_PATH_STUDENT;
